...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="images/m1.webp" alt="Bank" width="75" height="75" style="font-weight: bold; color:blue;"> <strong>Money
    ...
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        ...
        <a href="history.php"><button type="button" class="btn btn-primary fs-4 fw-bold btn-lg mb-3">See all Transaction History</button></a>
    </div>
    </div>

 <!-- Table -->
 <div class="container">
        <h2 class="text-center pt-4 fs-1 fw-bold" style="color : black;">Customer Details</h2>
            <?php
                include 'connect.php';
                $sid=$_GET['id'];
        ...
        <div>
            <table class="table bg-white table-hover">
                <tr style="color : white;" class="bg-primary fs-4 fw-bold">
