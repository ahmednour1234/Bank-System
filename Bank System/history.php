...
<div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
    <a href="money.php"><button type="button" class="btn  btn-lg mb-3 bg-primary text-white">Click Here to Transfer Money</button></a>
</div>
...
<!-- Table -->
    ...
    <table class="table table-hover bg-white">
        <thead style="color : white;" class="bg-primary">
            <tr>
                <th class="text-center fs-4 fw-bold">S.No.</th>
                <th class="text-center fs-4 fw-bold">Sender</th>
                <th class="text-center fs-4 fw-bold">Receiver</th>
                <th class="text-center fs-4 fw-bold">Amount</th>
                <th class="text-center fs-4 fw-bold">Date & Time</th>
            </tr>
        </thead>
        <tbody>
        <?php
